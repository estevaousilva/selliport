...
<head>
  <meta charset="UTF-8" />
  <title>SelliPort - Sistema de Gestão</title>
...
.stat-block.sales p {
  color: #b76e00;
    ...
    /* ... todo o CSS do seu exemplo anterior ... */
  </style>
</head>
<body>
  ...
  <main>
    <div class="header">
      ...
      <p>Controle de produtos, vendas, clientes e faturação.</p>
    </div>
    ...
    <div class="card">
      ...
      <table id="productList">
        ...
        <tbody>
          <?php
          $sql = "SELECT nome, preco, quantidade FROM produtos ORDER BY nome ASC";
          ...
          if ($result && $result->num_rows > 0) {
              ...
              echo '<tr><td colspan="3" style="text-align:center;">Nenhum produto encontrado.</td></tr>';
          }
          ?>
        </tbody>
      </table>
